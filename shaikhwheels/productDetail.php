                                        ...
                                        <tbody>
                                            <tr>
                                                <th class="pl-0 w-25" scope="row">
                                                    <h6 class="card-text mt-1">Type</h6>
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th class="pl-0 w-25" scope="row">
                                                    <h6 class="card-text mt-1">Year</h6>
                                                </th>
                                                <td>
                                                    <?php echo $row['year']; ?>
                                                </td>
                                            ...
                                            <tr>
                                                <th class="pl-0 w-25" scope="row">
                                                    <h6 class="card-text mt-1">Fuel</h6>
                                                </th>
                                                <td>
                                                    <?php echo $row['fuel']; ?>
                                                </td>
                                            ...
                                            <tr>
                                                <th class="pl-0 w-25" scope="row">
                                                    <h6 class="card-text mt-1">Transmission</h6>
                                                </th>
                                                <td>
                                                    <?php echo $row['gear']; ?>
                                                </td>
                                            ...
                                            <tr>
                                                <th class="pl-0 w-25" scope="row">
                                                    <h6 class="card-text mt-1">Ownership</h6>
                                                </th>
                                                <td>
                                            ...
                                            <tr>
                                                <th class="pl-0 w-25" scope="row">
                                                    <h6 class="card-text mt-1">Location</h6>
                                                </th>
                                                <td>
                                        ...
                                        <div class="col-12 col-sm-8">
                                            ...
                                            <div class="input-group rounded mb-1 mt-1">
                                                <form method="POST" action="order.php">
                                                    ...
                                                    <button onclick="order.submit()"
                                                        class="btn btn-secondary">Intrested</button>
                                                </form>
                                            </div>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <th class="pl-0 w-25" scope="row">
                                                                <h6 class="card-text mt-1">Name</h6>
                                                            </th>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <th class="pl-0 w-25" scope="row">
                                                                <h6 class="card-text mt-1">Contact</h6>
                                                            </th>
                                                            <td>
