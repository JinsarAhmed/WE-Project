                    ...
                    <div class="col-sm-3 mb-2 ">
                        <div class="input-group-lg rounded">
                            <form method="POST" action="search.php">
                                <input type="search" name="term" class="mb-2 form-control rounded" placeholder="Car Name"
                        ...
                        <div class="border mt-2 p-2">
                            <form name="brandSort" method="POST" action="brandSortedProduct.php">
                                <button type="submit" name="brand" value="Maruthi Suzuki"
                                    class="btn btn-outline-dark btn-light my-1">Maruthi Suzuki</button>
                                <button type="submit" name="brand" value="Mahindra"
                                    class="btn btn-outline-dark btn-light my-1">Mahindra</button>
                                <button type="submit" name="brand" value="Hundai"
                                    class="btn btn-outline-dark btn-light my-1">Hyndai</button>
                                <button type="submit" name="brand" value="Toyota"
                                    class="btn btn-outline-dark btn-light my-1">Toyota</button>
                                <button type="submit" name="brand" value="MG Motors"
                                    class="btn btn-outline-dark btn-light my-1">MG Motors</button>
                        ...
                        <div class="border mt-2 p-2">
                            <form name="priceSort" method="POST" action="priceSortedProduct.php">
                                ...
                                <button type="submit" name="price" value="0" class="btn btn-outline-dark btn-light my-1">0 -
                                    30 Lkh</button>
                                <button type="submit" name="price" value="3000000"
                                    class="btn btn-outline-dark btn-light my-1">30 - 60 Lkh</button>
                                <button type="submit" name="price" value="6000000"
                                    class="btn btn-outline-dark btn-light my-1">60 - 90 Lkh</button>
                                <button type="submit" name="price" value="9000000"
                                    class="btn btn-outline-dark btn-light my-1">90 - 120 Lkh</button>
                                <a href="product.php" class="btn btn-outline-dark btn-light my-1">All</a>
                            </form>
                        </div>
                    </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body my-1">
                                                    ...
                                                    <div class="d-flex justify-content-evenly">
                                                        <span class="card-text border border-grey rounded-pill p-1">
                                                            <?php echo $row['km'] ?>km
                                                        </span>
                                                        <span class="card-text border border-grey rounded-pill p-1">
                                                    ...
                                                    <span class="fs-3 card-text d-block"> <strong>Rs </strong>
                                                        <?php echo $row['price'] ?>
                                                    </span>
