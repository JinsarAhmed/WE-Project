                        ...
                        <li class="nav-item my-auto">
                            <form id="user" name="menuForm" method="POST" class="" action="productMenu.php">
                                <select onChange="user.submit()" name="userSel" id="usersel" class="userButton bg-light">
                                    ...
                                    <option value="Dashbord">Dashbaord</option>
            ...
            <section class="container mt-1">
                <div class="row">
                    ...
                    <div class="col-sm-4 list-group">
                        <a href="userDashbord.php" class="list-group-item list-group-item-action active">Dashboard</a>
                        <a href="userOrders.php" class="list-group-item list-group-item-action">Car Interested</a>
                                    ...
                                    if ($row['name'] != $_SESSION['name'] && $row['name'] != "admin") {
                                        ...
                                        <div class="card p-1">
                                            <div class="row">
                                                <div class="col">
                                                    <p>
                                                        <?php echo $row['name'] ?> has intrest in buying your car. Contact:
                                                        <?php echo $row['phone'] ?>
                                                    </p>
                                                </div>
                                            </div>
