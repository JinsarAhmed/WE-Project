            ...
            <section class="container mt-1">
                <div class="row">
                    ...
                    <div class="col-sm-4 list-group">
                        ...
                        <a href="adminDeleteDashbord.php" class="list-group-item list-group-item-action active">Delete
                            Account</a>
                    </div>

                    <div class="col-sm-8 feedMargin mx-auto">
                        <h6>Delete Account</h6>
                        <p>Deleting your account permently removes all data from the server. Are you sure you want to
                            delete?</p>
